...
window.onload = function init()
{
    ...
    document.getElementById("playRButton").onclick = function () {
        rotation = 1;    };
    document.getElementById("stopRButton").onclick = function () {
        rotation = 2;

    };

    document.getElementById("playTButton").onclick = function () {
        displacement_y = .2;
    };
    document.getElementById("stopTButton").onclick = function () {
        displacement_y = -3;
        velocity_y = 0.0;
        yAxis = 0;
    };
...
function initTexture() {
    ...
    var tetraImage = new Image();
    tetraImage.onload = function () { handleTextureLoaded(tetraImage, tetraTexture); }
    tetraImage.src = "Material/Brick.png";
}
